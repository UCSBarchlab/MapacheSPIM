# ============================================================================
# hello_asm.s - Your First RISC-V Assembly Program
# ============================================================================
#
# This program demonstrates the basics of RISC-V assembly:
...
# To run this program:
#   $ mapachespim
#   (mapachespim) load examples/riscv/hello_asm/hello_asm
#   (mapachespim) run
#
# ============================================================================
.isa riscv64
...
_start:
    ...
    #   2. Put the syscall number (4) in register a7
    #   3. Execute the ecall instruction

    la      a0, hello_msg   # la = "Load Address" - puts address of hello_msg into a0
    li      a7, 4           # li = "Load Immediate" - puts the value 4 into a7
    ecall                   # Make the syscall - this prints the string!
...
#   ecall            - Environment Call: invoke a syscall
#
# ============================================================================
